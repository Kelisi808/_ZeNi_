...
_ZeNi_/
  ...
  AGENTIC_AI.md                      ← what "agentic" actually means
  ...
  Language Options/                  ← extensive summaries in additional languages
    ...
    SUMMARY.zh-CN.md                 ← 中文 (简体)
    SUMMARY.fr.md                    ← Français
    SUMMARY.es.md                    ← Español
    SUMMARY.de.md                    ← Deutsch
    SUMMARY.da.md                    ← Dansk
    SUMMARY.el.md                    ← Ελληνικά
```
...
- **The fast scan** — read the [README](README.md), then the [Manifesto](MANIFESTO.md). Five minutes.
...
If you are an **AI assistant** working in this repository, read [AGENTS.md](AGENTS.md) first.

If you would like to **contribute**, read [CONTRIBUTING.md](CONTRIBUTING.md) first.

## Why the repository is flat

Every file lives at the root. The only subfolder is `Language Options/`, which is necessary to group the seven language files together.

This is a deliberate design choice: a visitor scanning the file list on GitHub sees the entire reading universe at once. No subfolders to hunt through, no second-tier "I might have missed something" anxiety. The repository is a curated set of essays and reference pieces, not a sprawling docs site.
