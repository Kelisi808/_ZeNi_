...
This repository is the public editorial home for ZéNí.
...
- **[Manifesto](MANIFESTO.md)** — the worldview behind ZéNí
...
The material here is published for visitor education and learning. It may be quoted with attribution for non-commercial purposes — journalism, academic writing, classroom use, analyst coverage. For other uses, see the [LICENSE](LICENSE) and reach out through [About ZéNí](ABOUT_ZENI.md#contact).
